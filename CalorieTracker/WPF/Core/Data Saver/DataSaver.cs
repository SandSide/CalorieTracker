...
using WPF.Core.Data_Saver;
using WPF.MVVM.Model;
using WPF.MVVM.ViewModel;

namespace WPF.Core
{
    /*internal class DateBasedFoodEntrySaver : IDataSavingStrategy<ObservableCollection<FoodItemViewModel>>
    {

        private readonly SettingsModel _settingsModel;
        
        public DataSaver(SettingsModel settingsModel)
        {
